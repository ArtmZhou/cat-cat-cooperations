...
public class CliAgentController {
    ...
    public ApiResponse<List<CliSessionService.OutputLogEntry>> getOutputLogs(
            @PathVariable String agentId,
            @RequestParam(defaultValue = "50") int limit) {
        List<CliSessionService.OutputLogEntry> logs = cliSessionService.getOutputLogs(agentId, limit);
    ...
    public ApiResponse<Void> clearOutputLogs(@PathVariable String agentId) {
        cliSessionService.clearOutputLogs(agentId);
        return ApiResponse.success();
    }
