...
GitHub Issues (primary) — `gh` CLI against `ArtmZhou/cat-cat-cooperations`. Local markdown under `.scratch/<feature>/` for quick/solo items. See `docs/agents/issue-tracker.md`.
